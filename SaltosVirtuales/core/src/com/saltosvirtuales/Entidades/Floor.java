...
public class Floor extends Actor {
     ...
     */
    public Floor(World world, Texture floor, Texture overfloor, float x, float width, float y) {
        this.world = world;
        this.floor = floor;
        ...
        setSize(width * Constantes.PIXELS_IN_METERS, Constantes.PIXELS_IN_METERS);
        setPosition(x * Constantes.PIXELS_IN_METERS, (y - 1) * Constantes.PIXELS_IN_METERS);
    }
